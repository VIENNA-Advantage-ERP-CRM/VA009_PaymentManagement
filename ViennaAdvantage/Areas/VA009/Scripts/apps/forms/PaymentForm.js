...
; (function (VA009, $) {
    ...
    VA009.PaymentForm = function () {
        ...
        var _loadFunctions = {
            ...
            Cheque_Pay_Dialog: function () {
                                ...
                                if (chqpaygrd.getChanges(event.recid) != undefined) {
                                    ...
                                    if (event.column == 6) {
                                        if (event.value_new == "") {
                                            ...
                                            //VIS_427 Converted new value to local string according to precision 
                                    ...
                                    if (event.column == 9) {
                                        ...
                                        if (chqpaygrd.records[event.index]['PaymwentBaseType'] == "ARR" || chqpaygrd.records[event.index]['PaymwentBaseType'] == "APP") {
                                            ...
                                            if (parseFloat(event.value_new) > chqpaygrd.records[event.index]['ConvertedAmt']) {
                                                //if (chqpaygrd.records[event.index]['ConvertedAmt'] < 0) {
                                                //    if (chqpaygrd.get(event.recid).changes.Writeoff == undefined && chqpaygrd.get(event.recid).changes.OverUnder == undefined) {
                                                //        if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                //            chqpaygrd.get(event.recid).changes.OverUnder = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['VA009_RecivedAmt'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //            chqpaygrd.get(event.recid).changes.OverUnder = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['VA009_RecivedAmt'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //        }
                                                //        else {
                                                //            chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + chqpaygrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                //            chqpaygrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + chqpaygrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                //        }
                                                //    }
                                                //    else if (chqpaygrd.get(event.recid).changes.Writeoff == undefined) {
                                                //        if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //        }
                                                //        else {
                                                //            chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + chqpaygrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                //            chqpaygrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + chqpaygrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                //        }
                                                //    }
                                                //    else if (chqpaygrd.get(event.recid).changes.OverUnder == undefined) {
                                                //        if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //        }
                                                //        else {
                                                //            chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                //            chqpaygrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                //        }
                                                //    }
                                                //    else {
                                                //        if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //        }
                                                //        else {
                                                //            chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                //            chqpaygrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqpaygrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                //        }
                                                //    }
                                                //}
                                                //else {
                                                ...
                                                //    }
                                                //    else {
                                                //        chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (parseFloat(event.value_new) - chqpaygrd.records[event.index]['ConvertedAmt']).toFixed(stdPrecision);
                                                //        chqpaygrd.get(event.recid).VA009_RecivedAmt = (parseFloat(event.value_new) - chqpaygrd.records[event.index]['ConvertedAmt']).toFixed(stdPrecision);
                                                //    }
                                                //}
                                                //chqpaygrd.refreshCell(event.recid, "VA009_RecivedAmt");
                                                //chqpaygrd.refreshCell(event.recid, "OverUnder");
                                                ...
                                                //    else {
                                                //        chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + chqpaygrd.records[event.index]['Writeoff'])).toFixed(stdPrecision);
                                                //        chqpaygrd.get(event.recid).VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + chqpaygrd.records[event.index]['Writeoff'])).toFixed(stdPrecision);
                                                //    }
                                                //}
                                                //else if (chqpaygrd.get(event.recid).changes.Writeoff == undefined) {
                                                //    if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //    }
                                                //    else {
                                                //        chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + chqpaygrd.records[event.index]['Writeoff'])).toFixed(stdPrecision);
                                                //        chqpaygrd.get(event.recid).VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + chqpaygrd.records[event.index]['Writeoff'])).toFixed(stdPrecision);
                                                //    }
                                                //}
                                                //else if (chqpaygrd.get(event.recid).changes.OverUnder == undefined) {
                                                //    if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //    }
                                                //    else {
                                                //        chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //        chqpaygrd.get(event.recid).VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqpaygrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //    }
                                                //}
                                                //else {
                                                //    if (VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) > 0) {
                                                ...
                                                //    }
                                                //    else {
                                                //        chqpaygrd.get(event.recid).changes.VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //        chqpaygrd.get(event.recid).VA009_RecivedAmt = (chqpaygrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqpaygrd.get(event.recid).changes.Writeoff))).toFixed(stdPrecision);
                                                //    }
                                                //}
                                                //chqpaygrd.refreshCell(event.recid, "VA009_RecivedAmt");
                                                //chqpaygrd.refreshCell(event.recid, "OverUnder");
                ...
                ChequePayDialog.onOkClick = function (event) {
                    ...
                    /*VIS_045: 24-July-2025, Check APC is greater than API then not to create Payment*/
                    if (IsAPCgreaterAPI(_CollaborateData) < 0) {
                        VIS.ADialog.info(("VA009_APCreditIsGreaterAPI"));
                        chqpaygrd.selectNone();
                        return false;
                    }
                    ...
                    chqrecgrd = CheueRecevableGrid.w2grid({
                        ...
                        onEditField: function (event) {
                            ...
                            if (event.column == 8 || event.column == 9 || event.column == 6) {
                                ...
                                $("#grid_CheueRecevableGrid_" + $self.windowNo + "_rec_" + id).keydown(function (event) {
                                    if (!dotFormatter && (event.keyCode == 190 || event.keyCode == 110)) {// , separator
                                        return false;
                                    }
                                    else if (dotFormatter && event.keyCode == 188) { // . separator
                                            ...
                                            if (parseFloat(event.value_new) > chqrecgrd.records[event.index]['ConvertedAmt']) {
                                                ...
                                                if (chqrecgrd.records[event.index]['ConvertedAmt'] > 0) {
                                                    if (chqrecgrd.get(event.recid).TransactionType == 'Order') {
                                                        chqrecgrd.get(event.recid).changes.Discount = ((chqrecgrd.records[event.index]['ConvertedAmt']) - parseFloat(event.value_new)).toFixed(stdPrecision);
                                        ...
                                        if (chqrecgrd.records[event.index]['PaymwentBaseType'] == "APP") {
                                            ...
                                            if (parseFloat(event.value_new) > chqrecgrd.records[event.index]['ConvertedAmt']) {
                                                if (chqrecgrd.records[event.index]['ConvertedAmt'] < 0) {
                                                    //if (chqrecgrd.get(event.recid).changes.Discount == undefined && chqrecgrd.get(event.recid).changes.OverUnder == undefined) {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    //        chqrecgrd.get(event.recid).changes.OverUnder = (chqrecgrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqrecgrd.records[event.index]['VA009_RecivedAmt'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).changes.OverUnder = (chqrecgrd.records[event.index]['ConvertedAmt'] - (parseFloat(event.value_new) + chqrecgrd.records[event.index]['VA009_RecivedAmt'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount))).toFixed(stdPrecision);
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + chqrecgrd.records[event.index]['Discount']))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + chqrecgrd.records[event.index]['Discount']))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else if (chqrecgrd.get(event.recid).changes.Discount == undefined) {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + chqrecgrd.records[event.index]['Discount']))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + chqrecgrd.records[event.index]['Discount']))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else if (chqrecgrd.get(event.recid).changes.OverUnder == undefined) {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount)))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount)))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount)))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Discount)))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                }
                                                else {
                                                    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                        ...
                                                        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (parseFloat(event.value_new) - chqrecgrd.records[event.index]['ConvertedAmt']).toFixed(stdPrecision);
                                                        //VIS_427 BugId 2325 handled Received to not be negative when user changes writeoff
                                                        if (chqrecgrd.get(event.recid).changes.VA009_RecivedAmt < 0) {
                                                            VIS.ADialog.error("MoreScheduleAmount");
                                                            chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = cultureAmtValue(event, (chqrecgrd.records[event.index]['VA009_RecivedAmt']));
                                        ...
                                        if (chqrecgrd.records[event.index]['PaymwentBaseType'] == "APP") {
                                            ...
                                            if (parseFloat(event.value_new) > chqrecgrd.records[event.index]['ConvertedAmt']) {
                                                if (chqrecgrd.records[event.index]['ConvertedAmt'] < 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + chqrecgrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + chqrecgrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else if (chqrecgrd.get(event.recid).changes.Writeoff == undefined) {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + chqrecgrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + chqrecgrd.records[event.index]['Writeoff']))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else if (chqrecgrd.get(event.recid).changes.OverUnder == undefined) {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + chqrecgrd.records[event.index]['OverUnder'] + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                    //else {
                                                    //    if (VIS.Utility.Util.getValueOfDecimal(chqrecgrd.records[event.index]['OverUnder']) > 0) {
                                                    ...
                                                    //    }
                                                    //    else {
                                                    //        chqrecgrd.get(event.recid).changes.VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                    //        chqrecgrd.get(event.recid).VA009_RecivedAmt = (-1 * ((-1 * chqrecgrd.records[event.index]['ConvertedAmt']) + (parseFloat(event.value_new) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.OverUnder) + VIS.Utility.Util.getValueOfDecimal(chqrecgrd.get(event.recid).changes.Writeoff)))).toFixed(stdPrecision);
                                                    //    }
                                                    //}
                                                }
                                                else {
                    ...
                    Cashgrd = CashGrid.w2grid({
                        ...
                        onEditField: function (event) {
                            ...
                            if (event.column == 8 || event.column == 7 || event.column == 5) {
                                $('#grid_CashGrid_rec_' + id).keydown(function (event) {
                                    if (!dotFormatter && (event.keyCode == 190 || event.keyCode == 110)) {// , separator
                                        return false;
                                    }
                                    else if (dotFormatter && event.keyCode == 188) { // . separator
                        ...
                        if (w2ui.CashGrid.getChanges(event.recid) != undefined) {
                            ...
                            if (event.column == 7) {
                                ...
                                if (Cashgrd.records[event.index]['PaymwentBaseType'] == "ARR" || Cashgrd.records[event.index]['PaymwentBaseType'] == "APP") {
                                    ...
                                    else if (parseFloat(event.value_new) <= Cashgrd.records[event.index]['ConvertedAmt']) {
        ...
        /* Function to convert value according to culture */
        function cultureAmtValue(event, amt) {
            amt = checkcommaordot(event, amt);
            amt = format.GetFormatAmount(amt, "init", dotFormatter);
            amt = format.GetConvertedString(amt, dotFormatter);
            return amt;
        };
        ...
        function checkCommaOrDotVal(val) {
            ...
            if (amount.contains(".")) {
                ...
                if (indices.length > 1) {
                    amount = removeAllButLast(amount, '.');
                }
            }
            if (amount.contains(",")) {
                if (foundComma) {
