...
public class X_C_PaymentTerm : PO
{
public X_C_PaymentTerm (Context ctx, int C_PaymentTerm_ID, Trx trxName) : base (ctx, C_PaymentTerm_ID, trxName)
{
...
public X_C_PaymentTerm (Ctx ctx, int C_PaymentTerm_ID, Trx trxName) : base (ctx, C_PaymentTerm_ID, trxName)
{
/** if (C_PaymentTerm_ID == 0)
{
SetAfterDelivery (false);
...
*/
public X_C_PaymentTerm (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaymentTerm (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaymentTerm (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_C_PaymentTerm()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27562514374037L;
/** Last Updated Timestamp 7/29/2010 1:07:37 PM */
public static long updatedMS = 1280389057248L;
/** AD_Table_ID=113 */
...
{
StringBuilder sb = new StringBuilder ("X_C_PaymentTerm[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set After Delivery.
...
{
Set_Value ("AfterDelivery", AfterDelivery);
}
/** Get After Delivery.
...
{
if (Discount2 == null) throw new ArgumentException ("Discount2 is mandatory.");
...
{
Set_Value ("DiscountDays2", DiscountDays2);
}
/** Get Discount Days 2.
@return Number of days from invoice date to be eligible for discount */
public int GetDiscountDays2() 
{
Object ii = Get_Value("DiscountDays2");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
/** Set Document Note.
...
{
Set_Value ("FixMonthDay", FixMonthDay);
}
/** Get Fix month day.
@return Day of the month of the due date */
public int GetFixMonthDay() 
{
Object ii = Get_Value("FixMonthDay");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
...
{
Set_Value ("IsDueFixed", IsDueFixed);
}
/** Get Fixed due date.
...
{
Set_Value ("IsNextBusinessDay", IsNextBusinessDay);
}
